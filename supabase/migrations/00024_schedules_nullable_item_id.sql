-- Quick 69: Make maintenance schedules not asset-locked (item_id optional)
-- Purpose: Allow schedules to be created without an asset for routine tasks
--          (e.g., monthly cleaning checklist) using general templates.

-- ============================================================================
-- 1. ALTER maintenance_schedules — make item_id nullable
-- ============================================================================
...
-- ============================================================================
-- 2. Recreate generate_pm_jobs() to handle NULL item_id
--    - Uses LEFT JOIN inventory_items instead of INNER JOIN
--    - Job title construction handles null asset name via COALESCE
-- ============================================================================
